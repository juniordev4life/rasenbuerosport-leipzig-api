...
- **auth:** Enforce the @redbulls.com account gate in requireAuth and harden auth inputs ([#85](https://github.com/juniordev4life/rasenbuerosport-leipzig-api/pull/85))

### 🏡 Chore

- Update version badge and changelog date for v1.8.5 ([dcac511](https://github.com/juniordev4life/rasenbuerosport-leipzig-api/commit/dcac511))
...
- **elo:** Rate a shootout as a win, not a draw ([#81](https://github.com/juniordev4life/rasenbuerosport-leipzig-api/pull/81))

### 🏡 Chore

- Update version badge and changelog date for v1.8.2 ([242fcef](https://github.com/juniordev4life/rasenbuerosport-leipzig-api/commit/242fcef))
...
[compare changes](https://github.com/juniordev4life/rasenbuerosport-leipzig-api/compare/v1.8.1...v1.8.2)

### 🩹 Fixes

- **recording:** Carry a failed capture onto the game row ([#80](https://github.com/juniordev4life/rasenbuerosport-leipzig-api/pull/80))

### 🏡 Chore

- Update version badge and changelog date for v1.8.1 ([9089f31](https://github.com/juniordev4life/rasenbuerosport-leipzig-api/commit/9089f31))
...
- **feedback:** Accept screenshot uploads on bug reports ([#63](https://github.com/juniordev4life/rasenbuerosport-leipzig-api/pull/63))

### 🏡 Chore

- Update version badge and changelog date for v1.6.0 ([b0c8803](https://github.com/juniordev4life/rasenbuerosport-leipzig-api/commit/b0c8803))
...
- **wrapped:** Extended highlights + talkrunde embed + week deep-link ([#60](https://github.com/juniordev4life/rasenbuerosport-leipzig-api/pull/60))

### 🏡 Chore

- Update version badge and changelog date for v1.4.0 ([e54878a](https://github.com/juniordev4life/rasenbuerosport-leipzig-api/commit/e54878a))
